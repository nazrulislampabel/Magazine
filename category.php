            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="hero-nav-area">
                        <h1 class="text-white"><?php echo single_cat_title();
							_e( " Category Post", "mymag" ); ?></h1>
            ...
            <div class="row">
                <div class="col-lg-8 post-list">
                    ...
                    <div class="latest-post-wrap">
                        <h4 class="cat-title"><?php echo _e("Latest Post","mymag")?></h4>
						<?php
						while ( have_posts() ) {
							the_post();
							?>
                            ...
                            <div class="col-lg-7 post-right">
                                ...
                                <ul class="meta">
                                    <li><a href="#"><span
                                                    class="lnr lnr-user"></span><?php esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) ?>
                                        </a></li>
                                    <li><a href="#"><span
                                                    class="lnr lnr-calendar-full"></span><?php echo get_the_date(); ?>
                                        </a></li>
                                    <li><a href="#"><span
                                                    class="lnr lnr-bubble"></span><?php echo get_comments_number() ?>
                                        </a></li>
                                </ul>
                                <p class="excert">
						...
						<?php } ?>
                        <div class="load-more">
                            <a href="#" id="load-more" class="primary-btn">Load More Posts</a>
                        </div>
                    </div>
