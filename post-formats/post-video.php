...
if(function_exists("the_field")){
	$mymag_video_file = get_field("source_file");
}
?>
                ...
                <div class="col-lg-12">
                    <div class="hero-nav-area">
                        ...
                        <p class="text-white link-nav"><a href="index.html">Home </a> <span
                                    ...
                                    class="lnr lnr-arrow-right"></span><a href="gallery-post.html">Video</a>
                        </p>
                    </div>
                </div>
                <div class="col-lg-12">
                ...
                <div class="col-lg-8 post-list">
                    ...
                    <div class="single-post-wrap">
                        <div class="feature-img-thumb relative">
                            <a href="<?php echo esc_url($mymag_video_file); ?>?color=01aef0&title=0&byline=0&portrait=0" data-lity>
		                        <?php the_post_thumbnail("mymag-home-square"); ?>
                            </a>
                        </div>
